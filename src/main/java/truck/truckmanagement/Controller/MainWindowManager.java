...
public class MainWindowManager {
    ...
    public void editUser(ActionEvent actionEvent) {
        ...
        if(selectedUserIsManager()){
            alertMessage(Alert.AlertType.ERROR, "Klaida", "Teisių apribojimas", "Neturite galimybės redaguoti kitus vadybininkus.");
            return;
        }
    ...
    private boolean selectedUserIsManager() {
        return userList.getSelectionModel().getSelectedItem().getRole().equals(Role_enum.VADYBININKAS);
    }
